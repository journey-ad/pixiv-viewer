...
; (function (root, factory) {
  ...
  function Swipe(container, options) {
    ...
    function setup(opts) {
      ...
      // console.log(index, options.continuous, slides.length)
      ...
      if (document.querySelector('.slider-after') && document.querySelector('.slider-before')) options.continuous = true

      // special case if two slides
      if (browser.transitions && options.continuous && slides.length < 3) {
        cloneNode(document.querySelector('.slider-after'));
        cloneNode(document.querySelector('.slider-before'));
